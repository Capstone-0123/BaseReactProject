...
// Next로 갈 거면 이 라인은 SSR에서 터질 수 있으니(의도적이라면 유지)
...
export default function Hero({ movie }: HeroProps) {
  ...
  return (
    <section
      className={`${styles.hero} relative z-20 h-[80vh] bg-cover bg-center flex items-end`}
      style={{
    ...
    >
      ...
      {/* 컨텐츠 */}
      <div className="relative z-10 p-8 md:p-16 max-w-4xl pb-24">
